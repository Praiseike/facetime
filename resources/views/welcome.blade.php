...
<head>
    ...
    <script>
        ...
        let serverPort = 8090;
        let connection = new WebSocket(`wss://${serverHost}:8090/?id={{ $user->id }}`);
    </script>
...
<body class="bg-slate-900">
    <div id="call-request" class="fixed hidden h-screen w-full backdrop-blur inset-0" id="overlay">
        <div class="h-[14rem] flex justify-center text-center items-center space-y-10 flex-col rounded-md border border-slate-700 p-4 mt-20 w-[40%] z-[50] bg-[#64748b11] mx-auto px-10">
    ...
    <div id="call-screen" class="fixed hidden h-screen w-full backdrop-blur inset-0" id="overlay">
        <div class="h-full w-[40%] mx-auto px-10">
    ...
    <div class="w-[70%] mx-auto h-screen px-20 py-20 text-slate-300 border-slate-700 border-r border-l">
